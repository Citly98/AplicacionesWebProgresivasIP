...
<head>
    ...
    <title>Mi proyecto Parcial-2 <?php echo date("d-m-Y"); ?></title>
    <link href="configuraciones/css/vapor.css" rel="stylesheet">
...
<body>
    <nav class="navbar navbar-expand-lg  navbar-light bg-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Proyecto 2do Parcial</a>
    ...
    <div class="container p-5 my-5 text-white">
        <div class="card-group">
            <div class="card border" style="margin-right: 5px;">
                <center>
                    <img src="configuraciones/imagenes/usuarios1.png" style="width: 30%;" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            <div class="card border">
                <center>
                    <img src="configuraciones/imagenes/Admin3.png" style="width: 30%;" class="card-img-top" alt="...">
                    <div class="card-body">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="submit" onclick="login_usuario()" class="btn btn-secondary">Ingresar</button>
