...
<head>
    ...
    <title>Proyecto Oscar Gallegos A. <?php echo date("d-m-Y"); ?></title>
    <link href="configuraciones/css/slate.css" rel="stylesheet">
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Oscar Gallegos - ProyectoP2</a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="submit" onclick="login_usuario()" class="btn btn-warning">Ingresar</button>
